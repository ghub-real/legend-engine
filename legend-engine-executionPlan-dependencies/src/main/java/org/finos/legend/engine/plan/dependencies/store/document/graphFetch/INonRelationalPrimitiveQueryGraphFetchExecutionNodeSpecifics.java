...
public interface INonRelationalPrimitiveQueryGraphFetchExecutionNodeSpecifics
{
    List<String> parentPrimaryKeyColumns(List<String> queryResultColumns);

    /* Prepare for reading */
    void prepare(DocumentResultSet resultSet, String databaseTimeZone, String databaseConnection);
