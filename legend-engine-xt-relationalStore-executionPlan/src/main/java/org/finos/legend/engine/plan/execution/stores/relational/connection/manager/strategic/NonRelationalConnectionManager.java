...
// TODO: goncah skeleton only from relational pattern, not being due to relational pattern close coupling to java.sql.Connection
...
// TODO: goncah, not being used yet
...
public class NonRelationalConnectionManager implements ConnectionManager
{
    ...
    private MutableList<Function<NonRelationalDatabaseConnection, DatasourceSpecificationVisitor<DataSourceSpecificationKey>>> dataSourceKeys;
    private MutableList<Function2<NonRelationalDatabaseConnection, ConnectionKey, DatasourceSpecificationVisitor<DataSourceSpecification>>> dataSourceTrans;
    ...
    public NonRelationalConnectionManager(int testDbPort, List<OAuthProfile> oauthProfiles, Optional<DatabaseAuthenticationFlowProvider> flowProviderHolder)
    {
        ...
        this.dataSourceKeys =Lists.mutable.empty();
    }

    private DataSourceSpecificationKey buildDataSourceKey(DatasourceSpecification datasourceSpecification, NonRelationalDatabaseConnection relationalDatabaseConnection)
    {
    ...
    private DataSourceSpecification buildDataSourceTrans(DatasourceSpecification datasourceSpecification, NonRelationalDatabaseConnection relationalDatabaseConnection, ConnectionKey connectionKey)
    {
        // TODO: temp workaround to return mongo data source always


//        DataSourceSpecificationTransformer transformer = new DataSourceSpecificationTransformer()
        return null;
//        MongoDBDatasourceSpecification dss = new MongoDBDatasourceSpecification();
//        dss.databaseName = "defaultDb";
//        dss.host = "localhost";
//        dss.port = 27017;
//        return dss;
...
//        new MongoDBDatasourceSpecification()
//        return key;
    }
    ...
    {
        if (connection instanceof NonRelationalDatabaseConnection)
        {
            NonRelationalDatabaseConnection relationalDatabaseConnection = (NonRelationalDatabaseConnection) connection;
