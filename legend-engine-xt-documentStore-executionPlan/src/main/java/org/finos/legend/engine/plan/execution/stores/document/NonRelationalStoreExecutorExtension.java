...
import org.finos.legend.engine.plan.execution.stores.relational.Function5;
...
public interface NonRelationalStoreExecutorExtension
{
    Function5<NonRelationalExecutionConfiguration, Connection, StreamingResult, String, String, RelationalDatabaseCommandsVisitor<Boolean>> getStreamResultToTempTableVisitor();
}
