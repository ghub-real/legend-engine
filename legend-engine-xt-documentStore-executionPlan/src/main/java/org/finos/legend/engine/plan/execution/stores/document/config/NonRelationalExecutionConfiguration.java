...
public class NonRelationalExecutionConfiguration implements StoreExecutorConfiguration
{
    ...
    public NonRelationalExecutionConfiguration()
    {
    }

    public NonRelationalExecutionConfiguration(String tempPath)
    {
    ...
    public static class Builder
    {
        ...
        public NonRelationalExecutionConfiguration build()
        {
            NonRelationalExecutionConfiguration relationalExecutionConfiguration = new NonRelationalExecutionConfiguration();
