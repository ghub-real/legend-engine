...
public class DataStoreConnection extends DatabaseConnection
{
    ...
    public DataStoreConnection(DatasourceSpecification datasourceSpecification, AuthenticationStrategy authenticationStrategy, DatabaseType databaseType)
    {
