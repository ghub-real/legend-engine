...
package org.finos.legend.engine.protocol.pure.v1.model.packageableElement.store.nonrelational.connection;
...
public class DocumentStoreConnection extends DatabaseConnection
{
    ...
    public DocumentStoreConnection()
    {

    }

    public DocumentStoreConnection(DatasourceSpecification datasourceSpecification, AuthenticationStrategy authenticationStrategy, DatabaseType databaseType)
    {
