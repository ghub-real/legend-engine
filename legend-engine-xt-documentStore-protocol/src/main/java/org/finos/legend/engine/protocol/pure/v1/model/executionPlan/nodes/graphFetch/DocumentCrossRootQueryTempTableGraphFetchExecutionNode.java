...
public class DocumentCrossRootQueryTempTableGraphFetchExecutionNode extends DocumentClassQueryTempTableGraphFetchExecutionNode
{
    public String parentTempTableName;
    public List<DocumentQueryResultField> parentTempTableColumns;
