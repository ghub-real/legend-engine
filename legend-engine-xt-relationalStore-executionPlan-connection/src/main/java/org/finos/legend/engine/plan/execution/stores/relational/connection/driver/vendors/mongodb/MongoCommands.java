...
// TODO: goncah figure out if this DBManager pattern can work for us, NonRelationalDatabaseCommands?
public class MongoCommands extends RelationalDatabaseCommands
{
    @Override
