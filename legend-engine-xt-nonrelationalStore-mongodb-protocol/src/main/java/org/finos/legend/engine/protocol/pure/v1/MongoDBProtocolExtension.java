...
import org.finos.legend.engine.protocol.pure.v1.model.packageableElement.store.relational.connection.MongoDatabaseConnection;

import java.util.List;
import java.util.Map;

public class MongoDBProtocolExtension implements PureProtocolExtension
{
    @Override
...
//                        .build(),
                ...
                ProtocolSubTypeInfo.newBuilder(Connection.class)
                        .withSubtype(MongoDatabaseConnection.class, "MongoDatabaseConnection")
                        .build()
                // Execution context
