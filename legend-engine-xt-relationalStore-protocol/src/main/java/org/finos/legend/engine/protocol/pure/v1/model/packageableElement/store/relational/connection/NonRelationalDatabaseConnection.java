...
public class NonRelationalDatabaseConnection extends DatabaseConnection
{
    ...
    public NonRelationalDatabaseConnection()
    {
        // jackson
    }

    public NonRelationalDatabaseConnection(DatasourceSpecification datasourceSpecification, AuthenticationStrategy authenticationStrategy, DatabaseType databaseType)
    {
