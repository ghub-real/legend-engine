...
public interface IDocumentStoreCompilerExtension extends CompilerExtension
{

    static List<IDocumentStoreCompilerExtension> getExtensions(CompileContext context)
    {
