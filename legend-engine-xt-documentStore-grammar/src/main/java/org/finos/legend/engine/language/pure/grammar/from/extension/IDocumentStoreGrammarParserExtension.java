...
public interface IDocumentStoreGrammarParserExtension extends PureGrammarParserExtension
{
    static List<IDocumentStoreGrammarParserExtension> getExtensions()
    {
        return Lists.mutable.withAll(ServiceLoader.load(IDocumentStoreGrammarParserExtension.class));
    }
