...
class Specifics
{
    ...
    void prepare(List<? extends org.finos.legend.engine.plan.dependencies.store.document.graphFetch.IDocumentQueryResultField> documentQueryResultFields,
...
//            this.propertyGetters.add(propertyGetter_0);
    ...
    IGraphInstance<? extends org.finos.legend.engine.plan.dependencies.store.shared.IReferencedObject> nextGraphInstance()
    {
        try
        {
            ...
            object.setSetId$("firm_set");
            object.setFirstName("john");
            object.setLastName("smith");
            Object pk$_0 = "someuniqueval567";
...
//            }
    ...
    {
        return Arrays.asList(Tuples.pair("meta::external::store::document::tests::object::MyDocStoreMapping",
                                         "firm_set"));
    }
